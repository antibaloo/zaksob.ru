...
if ($countNews > 0) {
  $res = CIBlockElement::GetList(array("ACTIVE_FROM" => "DESC"), array("IBLOCK_ID"=>7, "!PROPERTY_SLIDER" => false, "ACTIVE" => "Y", "<=DATE_ACTIVE_FROM" =>date($DB->DateFormatToPHP(CSite::GetDateFormat("FULL")), time()+CTimeZone::GetOffset())), false, array("nTopCount" => $countNews), array("PROPERTY_SLIDER","NAME","CODE","DETAIL_PAGE_URL","ACTIVE_FROM"));
