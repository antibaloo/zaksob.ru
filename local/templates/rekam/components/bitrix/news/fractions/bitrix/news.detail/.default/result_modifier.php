<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();
        ...
        if(!empty($arResult["DISPLAY_PROPERTIES"]["VICE_CHAIRMAN"]["VALUE"])){
          ...
          foreach($arResult["DISPLAY_PROPERTIES"]["VICE_CHAIRMAN"]["VALUE"] as $vice_chairman){
            $arDeputiesID[] = $vice_chairman;
          }  
        ...
        $arFilter = Array("IBLOCK_ID"=>IBLOCK_NEWS, "=PROPERTY_FRACTIONS"=>$arResult["ID"], "ACTIVE"=>"Y");
