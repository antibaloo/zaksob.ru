            ...
            <?if(!empty($arResult["CHAIRMAN"]) && !empty($arResult["DEPUTY"][$arResult["CHAIRMAN"]])):
                ...
                <div class="chiefs-grid__col">
                  <div class="chiefs-grid__col-heading">
                    <h2><?=GetMessage("DE_DETAIL_COMMITTEE_CHAIRMAN_TITLE");?></h2>
                  </div>
                  <div class="chief">
            ...
            <?if(!empty($arResult["VICE_CHAIRMAN"]) /*&& !empty($arResult["DEPUTY"][$arResult["VICE_CHAIRMAN"]])*/):
              ...
              foreach ($arResult["VICE_CHAIRMAN"] as $vice_chairman){
                ...
                <div class="chiefs-grid__col">
                  ...
                  <div class="chiefs-grid__col-heading">
                    <h2><?=GetMessage("DE_DETAIL_COMMITTEE_VICECHAIRMAN_TITLE");?></h2>
                  </div>
...
<?if(!empty($arResult["NEWS"])):?>
    <section class="section">
      <header class="section__header">
        <div class="section__title h1"><?=GetMessage("DE_DETAIL_COMMITTEE_NEWS");?></div>
      </header>
      <div class="section__body">
        ...
        <div class="card-slider slider">
          ...
          <div class="card-slider__btn card-slider__btn--prev">
            <svg class="i-icon">
              <use xlink:href="#icon-arrow"></use>
            </svg>
          </div>
          <div class="card-slider__btn card-slider__btn--next">
            <svg class="i-icon">
              <use xlink:href="#icon-arrow"></use>
            </svg>
          </div>
    ...
    <section class="section">
      <div class="section__body">
        ...
        <div class="highlighted highlighted--large-paddings">
          ...
          <h3><?=GetMessage("DE_DETAIL_COMMITTEE_DEPARTMENT");?></h3>
